...
function setCountScanTypeValue(callback) {
    ...
    txt_count_scantype_text.focus();
    txt_count_scantype_text.blur(function () { $(this).focus() })
    count_scantype_callback = callback;
}
function getCountScanTypeValue() {
    return {
        ScanKeyNo: txt_count_scantype_text.val()
    }
}
...
$(function () {
    txt_count_scantype_text.change(function (e) {
    ...
    txt_count_scantype_text.on('input', function () {
        //$("#txt_count_scantype_text").val(this.value);
    });
    //go back to top page
    $("#btn_close_count_scantype").click(function (e) {
        txt_count_scantype_text.unbind("blur");
        txt_count_scantype_text.blur();
        resetCountScanType();
